...
Meteor.methods({
 ...
 minusPoints: function(userId, points) {
    Players.update(userId, { $inc: { score: -points } });
  },

resetPoints: function(userId) {	
    Players.update(userId, {   score: 0 } );
...
var Leaderboard = ReactMeteor.createClass({
 ...
 minusFivePoints: function() {
    Meteor.call("minusPoints", Session.get("selected_player"), 5);
  },

resetPoints: function() {
    Meteor.call("resetPoints", Session.get("selected_player"));
  },
